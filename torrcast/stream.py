...
class Studio:
    ...
    Ключевой случай - «Кубик в Кубе»: формально они «двухголосый», но по крутости равны
    лучшим «многоголосым» студиям и стоят ВЫШЕ LostFilm. Решение - занести их в
    «многоголосый» с fame=10: честнее, чем давать fame право пересекать границы ступеней
    (это сломало бы лестницу в непредсказуемых местах). «Двухголосый» здесь означает
    формат записи, а не качество, и «Кубик в Кубе» сами не настаивают на этом ярлыке.
    """
...
STUDIOS: Final[dict[str, Studio]] = {
    ...
    # «Кубик в Кубе» формально двухголосые, но по крутости стоят выше LostFilm - и выше
    # большинства многоголосых. Заносим в «многоголосый» с большим весом: это честнее,
    # чем давать fame право пересекать ступени.
    "кубик в кубе": Studio("многоголосый", "Кубик в Кубе", fame=10),
...
def voice_order(track: AudioTrack) -> tuple[int, int, int]:
    ...
    Подробнее про fame и решение по «Кубику в Кубе» - в :class:`Studio`.
    """
    studio = track.studio
