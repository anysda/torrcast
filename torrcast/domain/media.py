...
class Media(_MediaPicture):
    ...
    def default_track(self, native: bool = False, language: str = "") -> int:
        ...
        русский многоголосый → прочий русский → английская дорожка → оригинал → чужой
        дубляж; служебные дорожки (тифлокомментарий, комментарии) — в самый низ. Выбор
        не молчаливый: подпись дорожки печатается в строке запуска.
