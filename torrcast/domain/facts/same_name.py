...
def same_name(title: str, heading: str) -> bool:
    ...
    (:func:`~torrcast.usecases.discover._second_language._second_language`). Годится только само имя:
    точное (:func:`akin` знает и другой порядок слов, и слитное написание) либо в другой
