...
def ru() -> dict[str, str]:
    ...
    return {
        ...
        "rank.no_language_tag_russian": "звук без метки языка - по имени релиза русская",
        ...
        "rank.voice_note": "дорожек rus {russian}, беру {what}{tail}{why}",
