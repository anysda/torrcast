...
def en() -> dict[str, str]:
    ...
    return {
        ...
        "select_bench.voice_search_phase": (
            "looking for a Russian dub: release {number} of {total} - "
        ),
        ...
        "select_bench.reason_no_russian_voice": "no Russian dub",
        "select_bench.honest_no_voice_note": "release {number} is not better (no Russian dub)",
        ...
        "select_bench.voiceless_head": "release {number} has no Russian dub ({lang})",
        ...
        "select_bench.mute_fallback_note": (
            "no Russian dub in any of the checked releases ({tried}) - "
        ...
        "select_bench.recheck_no_voice_note": (
            "release {number} answered alone, but without a Russian dub"
        ),
        "select_bench.refusal_none_fit": "no fit release ({shown}{more})",
        "select_bench.refusal_no_voice": (
            "no Russian dub in any of the checked releases ({count})"
        ),
