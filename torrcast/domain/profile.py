...
ANDROID_TV: Final = Profile(
    ...
    warn_mbit=28.0,  # снято: НЕ НАЗВАН · неизвестен · замер 09-08
    recode_at_mbit=28.0,  # снято: НЕ НАЗВАН · неизвестен · замер 09-08
    ...
    # снято: НЕ НАЗВАН · неизвестен · замер 09-08
    recode_mbit=28.0,  # снято: НЕ НАЗВАН · неизвестен · замер 09-08
    ...
    patience=577.0,  # снято: НЕ НАЗВАН · неизвестен · замер 09-08
    app_patience=577.0,  # снято: НЕ НАЗВАН · неизвестен · замер 09-08
    dead_url_seconds=4.0,  # снято: НЕ НАЗВАН · неизвестен · замер 09-08
    segment_retries=0,  # снято: НЕ НАЗВАН · неизвестен · замер 09-08
    revive_timeout=577.0,  # снято: НЕ НАЗВАН · неизвестен · замер 09-08
    revive_pause=10.0,  # снято: НЕ НАЗВАН · неизвестен · замер 09-08
    revive_drop=10.0,  # снято: НЕ НАЗВАН · неизвестен · замер 09-08
