...
# «ТВ-N» тут БЕЗ лукбехайнда `(?<!\()` из `_SERIES_HINT_RE`, и это замер, а не забывчивость:
# у аниме-приметы «(ТВ-2)» в скобках означает форму, а не телеканал. Перенос лукбехайнда на
# корпусах репы чинит два имени и ломает третье («Наруто (ТВ-2)»), маршрут не двигая вовсе.
