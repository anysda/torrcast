...
class Position:
    ...
    stale: bool = False
    #: Ответ знает позицию текущего приёмника. ``False`` бывает у вкладки до её первого
    #: доклада: ноль тогда честен для внешнего снимка, но упаковка остаётся у места старта.
    known: bool = True
