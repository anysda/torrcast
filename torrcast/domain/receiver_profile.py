...
class ReceiverProfile:
    ...
    #: Рой разгоняется 4.5--9.5 с. Пока после разгона не набрано полное окно в 10 с,
    #: скорость неизвестна: короткий нулевой счётчик не бракует раздачу ни у одного
    #: приёмника. Ошибка такого допуска дешевле ложного отказа хорошей раздаче.
