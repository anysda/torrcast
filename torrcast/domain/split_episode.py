...
from torrcast.domain.parse_episode import _PATTERNS, _Episode

__all__ = ["split_episode"]


def split_episode(text: str) -> tuple[str, Any | None]:
    ...
    for pattern in _PATTERNS:
        ...
        if match:
            ...
            return title, _Episode(int(match.group("season")), int(match.group("episode")))
