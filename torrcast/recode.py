...
Зачем. Q70D срывается в BUFFERING на сегментах примерно с 15 Мбит/с и выше. Лечить это
отбором (не брать честный тяжёлый 1080p вовсе) — значит терять качество там, где оно
есть. Тяжесть снимается не отбором, а перекодированием, и только там, где она есть.
...
#: приёмнику (:data:`torrcast.stream.RECODE_CODECS`). Выбирать тут не из чего, и это
