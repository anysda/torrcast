...
def _duration(key: str, entry: Entry, source: str) -> Entry:
    ...
    (:meth:`torrcast.adapters.recode.Weights.calibrate`). Своё число такая запись получит на первом
    ...
    :func:`torrcast.adapters.recode.level_for` как «4.1»: на 4К это враньё в поток (у 2160p 32400
