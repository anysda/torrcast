...
class _BenchWork(_BenchCore):
    ...
    def _voice_apart(self, prep: _Prep, plan: Plan) -> None:
        ...
        Спрашивается ровно там, где иначе релиз пошёл бы в брак: дорожки на языке зрителя
        внутри видеофайла нет. На здоровом релизе это не стоит ни одного лишнего ffprobe.
