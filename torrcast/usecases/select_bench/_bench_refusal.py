...
def _bench_refusal(
    ...
    человек и спрашивал, - раздачи-то годные, в них нет дорожки на языке зрителя. Ход при
    этом остаётся прежний: очередь кончилась - другой запрос, не кончилась - выбор руками.
    """
