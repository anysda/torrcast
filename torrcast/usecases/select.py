...
globals().update(
    legacy_namespace(
        torrcast=("InfraError", "NotFoundError", "SwarmError", "TorrcastError", "trace"),
        torrcast__commands=("EXIT_OK", "META_BUDGET", "PROBE_BUDGET"),
        torrcast__console=("Progress", "ask_line"),
        torrcast__parse=("Episode", "EpisodeFile", "Picture", "Release", "map_episodes"),
        torrcast__profile=("CAUTIOUS", "COPY", "REFUSE", "Profile"),
        torrcast__recode=("RECODE_HEIGHT",),
        torrcast__reinforce=("_nothing_late",),
        torrcast__search=("RawResult",),
        torrcast__state=("Config", "Entry", "State"),
        torrcast__stream=(
            "ContactWait",
            "Media",
            "ServerDownError",
