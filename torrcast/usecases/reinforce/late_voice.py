...
def _fresh(picture: Picture, menu: Sequence[Plan]) -> list[Release]:
    ...
    ему дороже полноты (:meth:`Bench.resolve`). На замере (живой приёмник, замороженный пул,
...
def late_voice(
    ...
    *,
    ...
    картинах класса (живой приёмник, живой Prowlarr) поздний круг по оригиналу картины сходил
