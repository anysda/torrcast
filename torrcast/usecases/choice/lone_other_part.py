"""Страж единственной найденной чужой части франшизы."""
...
def lone_other_part(plans: list[Plan], asked: str) -> str:
    """Назвать случай, когда нашлась ОДНА картина и она - не спрошенная часть.
    ...
    Строка остаётся причиной стража. Без ``--menu`` ступень взятия добавляет к ней
    автоматически взятую картину; за явным ``--menu`` ставит её над списком.
