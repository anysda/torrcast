...
def _named(picture: Picture, item: bool = False) -> str:
    ...
    на запросе «наруто» подпись стояла на 18 строках из 27 - и в консоли, и в карточке
    Home Assistant, поровну. Подпись на двух третях списка читается не лучше подписи ни
    на чём, а в карточке ей вдобавок не на что ссылаться: списка-линейки там нет вовсе.
