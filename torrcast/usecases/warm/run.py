...
def _run(
    ...
    (:class:`torrcast.adapters.recode.recoder.Recoder`), то есть стык звука на его границе у показа
    ...
    # 2-3 % вместо 33 % (:data:`torrcast.adapters.recode.pace.NEIGHBOUR_TOLL`).
