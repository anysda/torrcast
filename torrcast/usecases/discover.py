"""Сценарий поиска и построения планов показа."""
# ruff: noqa
# mypy: ignore-errors
...
def _no_budget(client: Prowlarr, what: str, progress: Progress) -> float | None:
    ...
    (:data:`~torrcast.facts.FACTS_BUDGET`, 1.5 с) и пола круга
    (:data:`~torrcast.search.CIRCLE_SHARE`, 1 с). Поэтому съеденная общая цель больше не
    ...
    ОДНОГО индексера, а не цена круга: :meth:`~torrcast.search.Prowlarr._circle` ждёт
