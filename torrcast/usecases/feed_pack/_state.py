...
RECODE_DIR: str
#: Положить общий заголовок показа (``EXT-X-MAP``) рядом с кусками, вырезав его из
#: названного куска. Работа эта адаптерная - разбор коробок файла и запись на диск, -
#: и лента только просит: своего заголовка у неё нет, а взять его надо и тогда, когда
#: куски идут с диска (:func:`torrcast.usecases.feed_pack.feed_head._head`).
