...
#: «прогрев пошёл» (:meth:`torrcast.warm.Warmer._run`).
...
class Encode:
    ...
    def fit(self, span: float, cap: float, cap_mbit: float = 0.0) -> Encode:
        ...
        """
        stream = import_module("torrcast.stream")
        AUDIO_MBIT, TS_OVERHEAD = stream.AUDIO_MBIT, stream.TS_OVERHEAD  # noqa: N806
...
class Recoder:
    ...
    def ready(self, slot: int) -> Path | None:
        ...
        segment_name = import_module("torrcast.stream").segment_name
    ...
    def _shrink_touched(self) -> float:
        ...
        SHRINK_DIR = import_module("torrcast.stream").SHRINK_DIR  # noqa: N806
    ...
    def note(self, slot: int, how: str) -> None:
        ...
        """
        recoded = how != "копия"
        TRACE = import_module("torrcast.stream").TRACE  # noqa: N806
    ...
    def _sweep(self) -> None:
        ...
        segment_slot = import_module("torrcast.stream").segment_slot
    ...
    def _run(self, first: int, last: int) -> None:
        stream = import_module("torrcast.stream")
        Packer, ffmpeg_pack_command = stream.Packer, stream.ffmpeg_pack_command  # noqa: N806
