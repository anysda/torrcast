...
class _State:
    ...
    #: Дальше этот огрызок лежал в :data:`torrcast.adapters.recode.RECODE_DIR` как готовый кусок и
    ...
    #: следит спрашиваемый (:meth:`torrcast.adapters.recode.Recoder.holding`).
