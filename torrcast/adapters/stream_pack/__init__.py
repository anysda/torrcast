...
Собирает разъехавшиеся по файлам единицы под прежним именем: отсюда их берёт
совместимый фасад :mod:`torrcast.stream` и всё, что звало упаковщика этим путём.
"""
