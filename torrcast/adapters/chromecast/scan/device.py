...
class Device:
    ...
    how: str = ""
    #: Производитель по паспорту устройства. В меню он не нужен - по нему выбирается профиль
    #: приёмника (:func:`torrcast.domain.for_passport.for_passport`), и часто он единственное, чем
    #: устройство себя называет: у приставки Xiaomi имя и модель приходят пустыми.
    maker: str = ""
