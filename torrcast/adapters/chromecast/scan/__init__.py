...
роутер пускают не всех. Поэтому приёмники ищутся сами: единственный найденный - он и
есть телевизор, берётся без вопроса (этим же сценарием его подхватывает сама
установка), а из нескольких человек выбирает свой номером из списка.
