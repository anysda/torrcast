...
def swarm_pulse(
    ...
    нет, и досиживать на нём весь :data:`torrcast.domain.pick_settings.PROBE_BUDGET` незачем,
    запасной уже греется параллельно (:meth:`torrcast.usecases.select_bench.bench.Bench.resolve`).
