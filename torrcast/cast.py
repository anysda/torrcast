...
class ChromecastReceiver:
    ...
    #: по §6.0) брать нельзя: перемотка на один кусок назад — обычное дело, и «максимум»
    ...
    def position(self, front: float = 0.0) -> Position:
        ...
        if pos > self._peak:  # реальный прогресс — прошлые нуджи больше не в счёт
        ...
        elif self._peak - pos > self.REWIND:
            ...
            # 06-08-2026: откат с 31:31 на 10:00, через 35 с показ выкинуло обратно на
