...
Живой холодный экземпляр, 14-09-2026: из индексеров ответил один
...
def test_several_neighbours_still_send_the_top_up_by_name_and_year() -> None:
    """Живой экземпляр: одни «Руки вверх» по-русски, и добор идёт строкой «Вверх 2009».
...
def test_a_picture_without_the_word_in_its_names_is_no_neighbour() -> None:
    """Живой экземпляр: «Грязные игры / Game of Love (Dirty Games)» 2021 при справке 2005.
