...
def test_a_silent_network_leaves_no_row_in_the_cache() -> None:
    ...
    заход спросил заново. Замер 07-09-2026 на живом приёмнике: «Форсаж» лёг пустым рядом
...
def test_a_degraded_passport_is_asked_again_live() -> None:
    ...
    полка глохла навсегда ещё до похода в Wikidata: замер 10-09-2026 на живом приёмнике -
...
def test_a_kind_named_by_the_releases_does_not_get_to_silence_the_whole_shelf() -> None:
    ...
    Замер 10-09-2026 на живом приёмнике: лучшим совпадением на «Чужой» продукт называет
