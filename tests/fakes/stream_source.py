...
class FakeStreamSource:
    ...
    lost: str = ""
    restored: bool = False
    #: Правда ли рой хоть раз за сеанс вёз достаточно и правда ли последняя жалоба была
    #: на просевший рой: этой парой конец показа снимает посмертный приговор рою.
    kept_up: bool = False
    thin: bool = False
    file_index: int = 0
    duration: float = 0.0
