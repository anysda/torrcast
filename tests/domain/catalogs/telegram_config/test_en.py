"""Английский каталог кластера настройки Telegram-бота: он же умолчание, он же запасной.
...
from torrcast.domain.catalogs.telegram_config.en import en as english
