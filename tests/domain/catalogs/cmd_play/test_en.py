"""Английский каталог кластера cmd_play: он же умолчание, он же запасной.
...
from torrcast.domain.catalogs.cmd_play.en import en as english
...
def test_every_key_names_its_cluster() -> None:
    stray = [key for key in english() if not key.startswith("cmd_play.")]
    assert stray == []
