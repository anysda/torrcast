"""Английский каталог кластера voices_command: он же умолчание, он же запасной.
...
from torrcast.domain.catalogs.voices_command.en import en as english
...
def test_every_key_names_its_cluster() -> None:
    stray = [key for key in english() if not key.startswith("voices_command.")]
    assert stray == []
