...
#: Статья, названная в точности как картина, но написанная НЕ про картину: пароход. Года
#: фильма в ней нет, и держалась она на одном послаблении точного имени (TC-957).
LINER = (
    "«Тита́ник» (англ. RMS Titanic) — британский трансатлантический грузопассажирский и "
    "почтовый пароход, второй лайнер класса «Олимпик» компании «White Star Line». Лайнер "
    "был построен для совершения регулярных рейсов между Саутгемптоном и Нью-Йорком."
)

#: Понятие под именем картины: ни кавычек в начале фразы, ни жанра, ни года.
LANDFORM = (
    "Дю́на — положительная форма рельефа; песчаный холм, образовавшийся под воздействием "
    "ветра. Понятие «дюны» применяется ко всем песчаным скоплениям."
)

#: Статья о картине, которая своего года не называет вовсе: ради неё послабление точного
#: имени и заведено, и снять его целиком нельзя.
REVOLUTIONS = (
