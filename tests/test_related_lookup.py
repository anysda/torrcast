...
def test_silence_is_not_asked_again_on_every_look_and_is_not_a_build_to_wait_for() -> None:
    ...
    захода карточки шёл в сеть заново, а карточка висела недоехавшей: живой приёмник,
...
def test_one_name_of_two_kinds_keeps_two_shelves_and_not_one() -> None:
    ...
    10-09-2026 на живом приёмнике - открытая первой карточка `tv:чужой:2021` гасила
