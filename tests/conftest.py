...
MACHINE_TESTS = frozenset(
    {
        ...
        "tests/adapters/wiki/test_address_memory.py::test_a_memoized_address_rides_over_a_dns_storm",
        "tests/adapters/wiki/test_address_memory.py::test_a_refusal_by_deadline_takes_its_resolver_thread_with_it",
...
def clip_hevc(tmp_path_factory: pytest.TempPathFactory) -> str:
    ...
    (:attr:`torrcast.domain.profile.Profile.recode_codecs`), а не посегментно по весу: смешанный
