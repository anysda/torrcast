...
единственный найденный в сети записывается без вопроса, из нескольких установка
спросит номер. `cast --tv` повторяет то же самое, если приёмник сменился, а известный
адрес можно записать сразу: `cast --tv <ip>`.
