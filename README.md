...
и кривые запросы), спрашивает **только про фильм и озвучку** и стримит торрент на ТВ
...
```
cast <запрос> [sNeM] [--new] [--audio N] [--dry]
...
Счастливый путь — два вопроса, и оба пропускаются, когда выбор единственный:
...
дорожки… 4.7 с
Озвучка: 1. rus · Дубляж  2. kaz · Дубляж  3. eng · Оригинал
Озвучка? [1]:
упаковка… 0.5 с
жду телевизор… 8.6 с
