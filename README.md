...
cast <запрос> --menu              # меню картин вместо продолжения начатого
```
...
`http.server`, точки входа, `python -m`), названо поимённо - в `vulture-whitelist.py` и в
корнях графа, и у каждой строки сказано, кто это имя зовёт.
