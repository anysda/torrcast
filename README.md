...
- ~30 ГБ свободного диска: ~20 ГБ под прогрев (`/var/lib/torrcast/warm`, бюджет меняется
  ...
  об этом и встанет, показ продолжится с живым окном, а кэш установка урежет или
  вернёт в память.
...
Все четыре обязаны кончиться кодом 0, и смотреть надо именно на код: `mypy` без
