...
class Replay:
    ...
    def above_default(self) -> list[Picture]:
        ...
        (:func:`~torrcast.usecases.choice.menu_lines.menu_lines`), а не по всем картинам франшизы, и
        первым пунктом у него стоит дефолт. Пока щуп звал «верхом меню» первую картину
        :func:`~torrcast.domain.menu_order.menu_order`, колонка врала ровно про них - печатала
        название и приписывала «→ Enter: другая» там, где никакого выбора человеку не показывали.
        """
