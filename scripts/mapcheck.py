...
метками». Расходился мультиплексор mpegts, которому не заглушили ``muxdelay`` и
``muxpreload``, а карта была точна. Чтобы такой вопрос закрывался замером за минуту, а не
сутками, здесь две независимые сверки одной и той же карты:
