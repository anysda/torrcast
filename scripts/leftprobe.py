...
пара событий, которую разводит :attr:`torrcast.adapters.browser.browser_receiver.
BrowserReceiver.left_after`: короче него - обновление НЕ роняет показ, длиннее -
