...
def tv_load(
    ...
    держал, и его канал к ТВ жил до конца процесса страницы (живой приёмник 11-09-2026: после
    «did not start the show: IDLE/ERROR» у экземпляра два канала к телевизору при пустом показе).
    """
