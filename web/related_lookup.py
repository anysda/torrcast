...
#: (живой приёмник, 11-09-2026: четыре фильма полки из пяти, по пять ``GET`` на карточку).
SILENT = 120.0
...
class RelatedLookup:
    ...
    def of(self, title: str, series: bool, entity: str = "") -> list[JsonValue] | None:
        ...
        отдавал одну другой: замер 10-09-2026 на живом приёмнике - у «Чужого» (2021, tv)
    ...
    def _build(self, title: str, series: bool, entity: str = "") -> None:
        ...
        (:data:`RETRY`) гасило бы полку одной оборванной связью (живой приёмник, 10-09-2026).
