...
# а один такой индексер задерживает весь поиск; ACG.RIP отрезает часть сетей на уровне
# TCP (:443 обрывается мгновенно, из других сетей отвечает) - обход означал бы возить
# трафик через чужую страну, а установка обязана работать из коробки без таких костылей.
# Трекеры с логином, капчей или ключом сюда не попадают ни при каких условиях.
