...
найденные перечислены, если их несколько, а пустой поиск не остаётся молчанием - экран
скажет, что включить и чем выбрать. Про mock-стенд там сказано отдельно: каста наружу у
него нет. Там же названа дверь в другой язык - `cast --en` в русской установке.
